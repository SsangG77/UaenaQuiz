...
import com.UaenaQuiz.uaenaquiz.databinding.*
...
class seventeenth : BaseActivity() {
    lateinit var mAdView : AdView
    private var mBinding: ActivitySeventeenthBinding? = null
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val checkBoolean : String = seventeenthBoolean

        var answer_text:String = "정답\n" +
                "'[충격] 아이유 탈민초파 선언?! 아이유에게 궁금한 8가지 Q & A'에서 INFJ로 바뀌었다고 얘기한다."
        ...
        mBinding = ActivitySeventeenthBinding.inflate(layoutInflater)
        setContentView(binding.root)

        val adView = AdView(this)
        adView.adSize = AdSize.BANNER
        adView.adUnitId = if (BuildConfig.DEBUG) "ca-app-pub-3940256099942544/6300978111" else "ca-app-pub-3545555975398754~5411865355"
