...
import com.UaenaQuiz.uaenaquiz.databinding.ActivityThirtyFourthBinding
...
/////////
open class thirtyFourth : BaseActivity() {
    lateinit var mAdView : AdView
    //    //
    private var mBinding: ActivityThirtyFourthBinding? = null
...
//        //
        val checkBoolean : String = thirtyFourthBoolean

//        //
        val answer_text:String = "정답\n" +
                "'주간아이돌 아이유편'에서 쇄골이 자신있다고 얘기한다."
        ...
        mBinding = ActivityThirtyFourthBinding.inflate(layoutInflater)
