...
import com.UaenaQuiz.uaenaquiz.databinding.ActivityThirteenthBinding
...
open class thirteenth : BaseActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val checkBoolean : String = thirteenthBoolean

        var answer_text:String = "정답\n" +
                "'[아이유의 집콕시그널] 옴망진창 팬미팅'에서 오랜지주스로 화채를 만든다고 언급한다."
