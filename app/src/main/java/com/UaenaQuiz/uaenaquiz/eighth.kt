...
import com.UaenaQuiz.uaenaquiz.databinding.ActivityEighthBinding
...
/////////
open class eighth : BaseActivity() {
    lateinit var mAdView : AdView
    private var mBinding: ActivityEighthBinding? = null
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val checkBoolean : String = eighthBoolean

        var answer_text:String = "정답\n" +
                "'아이와 나의 바다', '마음(공동작곡)'을 작곡한 '김제휘'가 정답이다."
        ...
        mBinding = ActivityEighthBinding.inflate(layoutInflater)
