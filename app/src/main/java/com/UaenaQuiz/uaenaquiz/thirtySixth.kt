...
import com.UaenaQuiz.uaenaquiz.databinding.ActivityThirtySixthBinding
...
/////////
open class thirtySixth : BaseActivity() {
    lateinit var mAdView : AdView
    //    //
    private var mBinding: ActivityThirtySixthBinding? = null
...
//        //
        val checkBoolean : String = thirtySixthBoolean

//        //
        val answer_text:String = "정답\n" +
                "SBS 파워FM은 개국 20주년을 맞아 로고송을 아이유가 리메이크하였다."
        ...
        mBinding = ActivityThirtySixthBinding.inflate(layoutInflater)
...
//            //
            val intent = Intent(this, thirtySeventh::class.java)
            startActivity(intent)
