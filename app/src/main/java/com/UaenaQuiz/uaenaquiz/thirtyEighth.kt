...
import com.UaenaQuiz.uaenaquiz.databinding.ActivityThirtyEighthBinding
...
/////////
open class thirtyEighth : BaseActivity() {
    lateinit var mAdView : AdView
    //    //
    private var mBinding: ActivityThirtyEighthBinding? = null
...
//        //
        val checkBoolean : String = thirtyEighthBoolean

//        //
        val answer_text:String = "정답\n" +
                "놀러와 329회에서 3학년 14반이라고 언급된다."
        ...
        mBinding = ActivityThirtyEighthBinding.inflate(layoutInflater)
...
//            //
            val intent = Intent(this, thirtyNinth::class.java)
            startActivity(intent)
