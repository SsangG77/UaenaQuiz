...
import com.UaenaQuiz.uaenaquiz.databinding.ActivityThirtyFifthBinding
...
/////////
open class thirtyFifth : BaseActivity() {
    lateinit var mAdView : AdView
    //    //
    private var mBinding: ActivityThirtyFifthBinding? = null
...
//        //
        val checkBoolean : String = thirtyFifthBoolean

//        //
        val answer_text:String = "정답\n" +
                "아이유는 2016년에는 '달의 연인-보보경심 려'의 주인공에 캐스팅 되어 한해 내내 촬영에 매진했다."
        ...
        mBinding = ActivityThirtyFifthBinding.inflate(layoutInflater)
...
//            //
            val intent = Intent(this, thirtySixth::class.java)
            startActivity(intent)
