...
import com.example.uaenaquiz.databinding.ActivityFifthBinding
...
open class fifth : BaseActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        var answer_text:String = "정답\n" +
                "[IU TV]-장만월에게 물어봐 편에 장만월이 직접 대답한다."
        var wrong_answer_text:String = "오답\n" +
                "[IU TV]-장만월에게 물어봐 편에 장만월이 직접 대답한다."

        var setview = setContentView(R.layout.activity_fifth)
