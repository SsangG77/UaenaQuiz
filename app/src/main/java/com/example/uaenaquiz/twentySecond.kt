...
import com.example.uaenaquiz.databinding.ActivityTwentyFirstBinding
import com.example.uaenaquiz.databinding.ActivityTwentySecondBinding
import com.google.android.gms.ads.AdRequest
import com.google.android.gms.ads.AdView
import com.google.android.gms.ads.MobileAds

/////////
open class twentySecond : BaseActivity() {

    lateinit var mAdView : AdView

    val TAG: String = "로그"

    private var mBinding: ActivityTwentySecondBinding? = null
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        var answer_text:String = "정답\n" +
                "'[IU TV] 훈이가 보는 지은이' 유튜브 영상에서 언급한다."
        var wrong_answer_text:String = "오답\n" +
                "'[IU TV] 훈이가 보는 지은이' 유튜브 영상에서 언급한다."

        var setview = setContentView(R.layout.activity_twenty_second)
        ...
        setview
        mBinding = ActivityTwentySecondBinding.inflate(layoutInflater)
                ...
                binding.thirdRadioBtn -> {
                    binding.check.setOnClickListener {
                        ...
                        binding.arrowForward.setOnClickListener {
                            val intent = Intent(this, twentyThird::class.java)
