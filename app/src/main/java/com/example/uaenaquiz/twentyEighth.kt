...
import com.example.uaenaquiz.databinding.ActivityTwentyEighthBinding
import com.google.android.gms.ads.AdRequest
import com.google.android.gms.ads.AdView
import com.google.android.gms.ads.MobileAds

/////////
open class twentyEighth : BaseActivity() {

    lateinit var mAdView : AdView

    val TAG: String = "로그"

    private var mBinding: ActivityTwentyEighthBinding? = null
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        var answer_text:String = "정답\n" +
                "2014년 7월 8일에 발매된 god의 정규 앨범 Chapter 8의 수록곡 <노래 불러줘요>에 피쳐링으로 참여했다."
        var wrong_answer_text:String = "오답\n" +
                "2014년 7월 8일에 발매된 god의 정규 앨범 Chapter 8의 수록곡 <노래 불러줘요>에 피쳐링으로 참여했다."

        var setview = setContentView(R.layout.activity_twenty_eighth)
        ...
        setview
        mBinding = ActivityTwentyEighthBinding.inflate(layoutInflater)
                ...
                binding.fourthRadioBtn -> {
                    binding.check.setOnClickListener {
                        ...
                        binding.arrowForward.setOnClickListener {
                            val intent = Intent(this, twentyNinth::class.java)
