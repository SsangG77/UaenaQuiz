...
import com.example.uaenaquiz.databinding.ActivityTwentiethBinding
import com.google.android.gms.ads.AdRequest
import com.google.android.gms.ads.AdView
import com.google.android.gms.ads.MobileAds

/////////
open class twentieth : BaseActivity() {

    lateinit var mAdView : AdView

    val TAG: String = "로그"

    private var mBinding: ActivityTwentiethBinding? = null
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        var answer_text:String = "정답\n" +
                "'자장가'는 작사에만 참여하고 '김희원'작곡가님이 작곡을 하였다."
        var wrong_answer_text:String = "오답\n" +
                "'자장가'는 작사에만 참여하고 '김희원'작곡가님이 작곡을 하였다."

        var setview = setContentView(R.layout.activity_twentieth)
        ...
        setview
        mBinding = ActivityTwentiethBinding.inflate(layoutInflater)
                ...
                binding.thirdRadioBtn -> {
                    binding.check.setOnClickListener {
                        ...
                        binding.arrowForward.setOnClickListener {
                            val intent = Intent(this, twentyFirst::class.java)
