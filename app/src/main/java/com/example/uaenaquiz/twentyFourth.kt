...
import com.example.uaenaquiz.databinding.ActivityTwentyFourthBinding
...
/////////
open class twentyFourth : BaseActivity() {

    lateinit var mAdView : AdView

    val TAG: String = "로그"

    private var mBinding: ActivityTwentyFourthBinding? = null
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        var answer_text:String = "정답\n" +
                "아이유의 첫 예능인 영웅호걸은 2010년 7월 18일부터 2011년 5월 1일까지 방영되었다."
        var wrong_answer_text:String = "오답\n" +
                "아이유의 첫 예능인 영웅호걸은 2010년 7월 18일부터 2011년 5월 1일까지 방영되었다."

        var setview = setContentView(R.layout.activity_twenty_fourth)
        ...
        setview
        mBinding = ActivityTwentyFourthBinding.inflate(layoutInflater)
                ...
                binding.fourthRadioBtn -> {
                    binding.check.setOnClickListener {
                        ...
                        binding.arrowForward.setOnClickListener {
                            val intent = Intent(this, twentyFifth::class.java)
