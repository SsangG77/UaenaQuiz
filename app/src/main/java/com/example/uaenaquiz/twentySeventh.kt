...
import com.example.uaenaquiz.databinding.ActivityTwentySeventhBinding
import com.google.android.gms.ads.AdRequest
import com.google.android.gms.ads.AdView
import com.google.android.gms.ads.MobileAds

/////////
open class twentySeventh : BaseActivity() {

    lateinit var mAdView : AdView

    val TAG: String = "로그"

    private var mBinding: ActivityTwentySeventhBinding? = null
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        var answer_text:String = "정답\n" +
                "2011년 방영된 '드림하이'가 아이유의 첫 연기 데뷔작이다."
        var wrong_answer_text:String = "오답\n" +
                "2011년 방영된 '드림하이'가 아이유의 첫 연기 데뷔작이다."

        var setview = setContentView(R.layout.activity_twenty_seventh)
        ...
        setview
        mBinding = ActivityTwentySeventhBinding.inflate(layoutInflater)
                ...
                binding.secondRadioBtn -> {
                    binding.check.setOnClickListener {
                        ...
                        binding.arrowForward.setOnClickListener {
                            val intent = Intent(this, twentyEighth::class.java)
