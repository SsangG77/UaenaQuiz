...
/////////
open class twentyFirst : BaseActivity() {

    lateinit var mAdView : AdView

    val TAG: String = "로그"

    private var mBinding: ActivityTwentyFirstBinding? = null
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        var answer_text:String = "정답\n" +
                "아이유는 구찌는 2019년, 뉴발란스는 2021년에 앰버서더로 선정되었다."
        var wrong_answer_text:String = "오답\n" +
                "아이유는 구찌는 2019년, 뉴발란스는 2021년에 앰버서더로 선정되었다."

        var setview = setContentView(R.layout.activity_twenty_first)
        ...
        setview
        mBinding = ActivityTwentyFirstBinding.inflate(layoutInflater)
                ...
                binding.fourthRadioBtn -> {
                    binding.check.setOnClickListener {
                        ...
                        binding.arrowForward.setOnClickListener {
                            val intent = Intent(this, twentySecond::class.java)
