...
import com.example.uaenaquiz.databinding.ActivityNinthBinding
import com.google.android.gms.ads.AdRequest
import com.google.android.gms.ads.AdView
import com.google.android.gms.ads.MobileAds

/////////
open class ninth : BaseActivity() {
    ...
    //////
    private var mBinding: ActivityNinthBinding? = null
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        var answer_text:String = "정답\n" +
                "'Love Poem'곡 소개 설명란에 작성되어 있다."
        var wrong_answer_text:String = "오답\n" +
                "'Love Poem'곡 소개 설명란에 작성되어 있다."

        var setview = setContentView(R.layout.activity_ninth)
        ...
        setview
        mBinding = ActivityNinthBinding.inflate(layoutInflater)
