...
import com.example.uaenaquiz.databinding.*
import com.google.android.gms.ads.AdRequest
import com.google.android.gms.ads.AdView
import com.google.android.gms.ads.MobileAds

/////////
open class sixteenth : BaseActivity() {
    ...
    //////
    private var mBinding: ActivitySixteenthBinding? = null
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        var answer_text:String = "정답\n" +
                "'[IU TV] 타임머신 편ㅣ아직도 남아 있는 너의 향기'에서 아이유가 언급한다."
        var wrong_answer_text:String = "오답\n" +
                "'[IU TV] 타임머신 편ㅣ아직도 남아 있는 너의 향기'에서 아이유가 언급한다."

        var setview = setContentView(R.layout.activity_sixteenth)
        ...
        setview
        mBinding = ActivitySixteenthBinding.inflate(layoutInflater)
                ...
                binding.secondRadioBtn -> {
                    binding.check.setOnClickListener {
                        ...
                        binding.arrowForward.setOnClickListener {
                            //////LastPage
                            val intent = Intent(this, seventeenth::class.java)
